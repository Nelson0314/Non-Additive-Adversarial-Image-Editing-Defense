...
#
# 用法：bash scripts/purify_ig_loss.sh "<五個卡號>"
set -uo pipefail
...
TAGS="${2:-ln_eot ig_noeot ig_eot ig_r40_eot ig_blend_eot ig_hit_eot ig_lot_eot ig_f08_eot}"
WANT_FLOOR=1
