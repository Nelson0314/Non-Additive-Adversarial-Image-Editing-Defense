...
# 這一批有 `r80`／`r160_eot` 兩個刻意把失真推到很難看的探針，圖更是必要。
#
# 用法：bash scripts/purify_eot_ceiling.sh "<五個卡號>"
set -uo pipefail
