#!/usr/bin/env bash
# `runs/ip2p_gate_floor`（紋理閘 × 頻譜加性下限的 2×4 全因子）的抗淨化那一半。
#
...
#
# 用法：bash scripts/purify_gate_floor.sh "<五個卡號>"
set -uo pipefail
...
TAGS="${2:-g1_f00 g0_f00 g1_f04 g0_f04 g1_f08 g0_f08 g1_f12 g0_f12}"
WANT_FLOOR=1
