...
--steps 6000 --step-size 0.01 \
--eval-every 400 --eval-draws 8 --patience 8 --min-delta 0.0002 \
--save-weights --skip-existing"

POINTS="
sb_f35:--floor-r-max~0.35~$EOT
sb_f55:--floor-r-max~0.55~$EOT
sb_surv:--floor-survival~blur12~$EOT
sb_f35_surv:--floor-r-max~0.35~--floor-survival~blur12~$EOT
"
