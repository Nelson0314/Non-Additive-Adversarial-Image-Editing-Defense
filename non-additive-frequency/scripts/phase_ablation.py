...
def build(name: str, seed: int, block: int = 32, r_min: float = 0.12,
          ...
          floor_r_min=None, floor_r_max=None, floor_survival: str = "none",
          floor_envelope: str = "none", floor_envelope_k: int = 1,
    ...
    if name == "phase":
        return (PhaseParam(size=RESOLUTION, block=block, r_min=r_min,
                           ...
                           floor_r_max=floor_r_max,
                           floor_survival=floor_survival,
                           floor_envelope=floor_envelope,
                           floor_envelope_k=floor_envelope_k,
                           floor_envelope_scope=floor_envelope_scope,
