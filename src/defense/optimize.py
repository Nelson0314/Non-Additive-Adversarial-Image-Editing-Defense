...
# `align_apa_native` 已移到 `src/defense/apa_stage1.py`（PLAN.md §6.1a）。
# 此處重新匯出，使舊主線既有的 `optimize.align_apa_native` 呼叫維持不變。
from src.defense.apa_stage1 import align_apa_native   # noqa: E402,F401
